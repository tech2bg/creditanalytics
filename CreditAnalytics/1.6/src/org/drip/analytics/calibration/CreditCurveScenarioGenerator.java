...
public class CreditCurveScenarioGenerator {
	...
	private org.drip.analytics.calibration.NewtonRaphsonCalibrator _compCalib = new
		...
		final boolean bFlat)
	{
		if (null == strName || null == adblQuotes || null == astrCalibMeasure || null == valParams || null ==
			dc || adblQuotes.length != astrCalibMeasure.length || _aCalibInst.length !=
				astrCalibMeasure.length || java.lang.Double.isNaN (dblBump) || java.lang.Double.isNaN
					(dblRecovery))
			return null;
