...
public class DerivedFXBasisCurve extends org.drip.analytics.definition.FXBasisCurve {
		...
		throws java.lang.Exception
	{
		if (null == cp || null == dtSpot || java.lang.Double.isNaN (dblFXSpot) || null == adblDate || 0 ==
			adblDate.length || null == adblFXBasis || 0 == adblFXBasis.length || adblDate.length !=
				adblFXBasis.length)
		...
		final double dblShift)
	{
		...
		try {
			return new DerivedFXBasisCurve (_cp, new org.drip.analytics.date.JulianDate (_dblSpotDate),
	...
	{
		try {
			return new DerivedFXBasisCurve (ab);
		} catch (java.lang.Exception e) {
			e.printStackTrace();
		}
		...
		throws java.lang.Exception
	{
		...
		DerivedFXBasisCurve fxBasis = new DerivedFXBasisCurve (new org.drip.product.params.CurrencyPair
		...
		DerivedFXBasisCurve fxBasisDeser = new DerivedFXBasisCurve (abFXBasis);
