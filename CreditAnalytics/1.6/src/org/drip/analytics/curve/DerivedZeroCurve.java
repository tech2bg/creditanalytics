...
public class DerivedZeroCurve extends org.drip.analytics.definition.ZeroCurve {
		...
		throws java.lang.Exception
	{
		...
		if (java.lang.Double.isNaN (dblYearFraction) || 0. > dblYearFraction) return;
	...
	public DerivedZeroCurve (
		...
		throws java.lang.Exception
	{
		if (null == (_dc = dc) || null == lsPeriod || 0 == lsPeriod.size() || java.lang.Double.isNaN
			(dblWorkoutDate) || java.lang.Double.isNaN (dblCashPayDate) || java.lang.Double.isNaN
				(dblZCBump))
	...
	@Override public double getDF (
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblDate)) throw new java.lang.Exception ("ZC.getDF got NaN for date");
