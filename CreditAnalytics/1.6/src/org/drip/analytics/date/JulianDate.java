...
public class JulianDate implements java.lang.Comparable<JulianDate> {
	...
	{
		if (java.lang.Double.isNaN (dblJulianIn)) return null;
	...
	{
		if (java.lang.Double.isNaN (dblJulianIn))
	...
	public static final double DaysElapsed (
		...
		throws java.lang.Exception
	{
		...
		return dblDate - toJulian (Year (dblDate), JANUARY, 1);
	}
	...
	public static final double DaysRemaining (
		final double dblDate)
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblDate))
		...
		return toJulian (Year (dblDate), DECEMBER, 31) - dblDate;
	}
	...
	public static final boolean ContainsFeb29 (
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblStart) || java.lang.Double.isNaN (dblEnd))
			throw new java.lang.Exception ("JulianDate.ContainsFeb29 got NaN input!");

		double dblLeftYear = dblStart;
		double dblRightYear = dblEnd;

		while (!IsLeapYear (dblLeftYear)) dblLeftYear -= 365;

		while (!IsLeapYear (dblRightYear)) dblRightYear += 365;

		dblLeftYear = toJulian (Year (dblLeftYear), FEBRUARY, 29);

		dblRightYear = toJulian (Year (dblRightYear), FEBRUARY, 29);

		if (0 == (iIncludeSide & LEFT_INCLUDE)) ++dblLeftYear;

		if (0 == (iIncludeSide & RIGHT_INCLUDE)) --dblRightYear;

		for (double dblFeb29 = dblLeftYear; dblFeb29 <= dblRightYear; dblFeb29 += 1461) {
			if (dblStart < dblFeb29 && dblEnd >= dblFeb29) return true;
		}
	...
	public JulianDate (
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblJulian))
