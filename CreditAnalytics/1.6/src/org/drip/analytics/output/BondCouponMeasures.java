...
public class BondCouponMeasures extends org.drip.service.stream.Serializer {
	...
	{
		if (java.lang.Double.isNaN (dblDV01) || java.lang.Double.isNaN (dblCouponPV) ||
			java.lang.Double.isNaN (dblPV))
	...
	{
		if (java.lang.Double.isNaN (dblCashPayDF)) return false;
	...
	{
		if (java.lang.Double.isNaN (dblAccrued01) || java.lang.Double.isNaN (dblCoupon)) return false;
