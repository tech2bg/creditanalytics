...
public class BondWorkoutMeasures extends org.drip.service.stream.Serializer {
	...
	public BondWorkoutMeasures (
		...
		throws java.lang.Exception
	{
		if (null == bcmCreditRisklessDirty || java.lang.Double.isNaN (dblCreditRisklessParPV) ||
			java.lang.Double.isNaN (dblCreditRisklessPrincipalPV) || java.lang.Double.isNaN (dblAccrued01) ||
				java.lang.Double.isNaN (dblFirstCouponRate))
