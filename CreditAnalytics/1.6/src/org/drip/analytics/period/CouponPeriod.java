...
public class CouponPeriod extends Period {
	...
	{
		if (java.lang.Double.isNaN (dblEffective) || java.lang.Double.isNaN (dblMaturity) || dblEffective >=
			dblMaturity || 0 == iFreq)
			return null;
	...
	@Override public double getAccrualDCF (
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblAccrualEnd)) throw new java.lang.Exception ("Accrual end is NaN!");
		...
		return org.drip.analytics.daycount.Convention.YearFraction (_dblAccrualStart, dblAccrualEnd,
			_strAccrualDC, _bApplyAccEOMAdj, _dblMaturity, new org.drip.analytics.daycount.ActActDCParams
				(_iFreq, _dblAccrualStart, _dblAccrualEnd), _strCalendar) * _dblDCF /
					org.drip.analytics.daycount.Convention.YearFraction (_dblAccrualStart, _dblAccrualEnd,
						_strAccrualDC, _bApplyAccEOMAdj, _dblMaturity, new
							org.drip.analytics.daycount.ActActDCParams (_iFreq, _dblAccrualStart,
								_dblAccrualEnd), _strCalendar);

		/* return org.drip.analytics.daycount.DayCountBasis.YearFraction (_dblAccrualStart, dblAccrualEnd,
			_strAccrualDC, _bApplyAccEOMAdj, _dblMaturity, new org.drip.analytics.daycount.ActActDCParams
