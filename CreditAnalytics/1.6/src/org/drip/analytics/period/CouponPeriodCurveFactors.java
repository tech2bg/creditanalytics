...
public class CouponPeriodCurveFactors extends Period {
		...
		throws java.lang.Exception
	{
		...
		if (java.lang.Double.isNaN (_dblFullCouponRate = dblFullCouponRate) || java.lang.Double.isNaN
			(_dblStartNotional = dblStartNotional) || java.lang.Double.isNaN (_dblEndNotional =
				dblEndNotional) || java.lang.Double.isNaN (_dblStartDF = dblStartDF) ||
					java.lang.Double.isNaN (_dblEndDF = dblEndDF) || java.lang.Double.isNaN
						(_dblStartSurvival = dblStartSurvival) || java.lang.Double.isNaN (_dblEndSurvival =
							dblEndSurvival))
