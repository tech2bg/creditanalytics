...
public class Period extends org.drip.service.stream.Serializer {
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblStart) || java.lang.Double.isNaN (dblEnd) || java.lang.Double.isNaN
			(dblAccrualStart) || java.lang.Double.isNaN (dblAccrualEnd) || java.lang.Double.isNaN (dblDCF) ||
				dblStart > dblEnd || dblAccrualStart > dblAccrualEnd) {
	...
	public boolean setAccrualStartDate (
		final double dblAccrualStart)
	{
		if (java.lang.Double.isNaN (dblAccrualStart)) return false;
	...
	public boolean setPayDate (
		final double dblPay)
	{
		if (java.lang.Double.isNaN (dblPay)) return false;
