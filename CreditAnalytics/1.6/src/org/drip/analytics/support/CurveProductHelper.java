...
public class CurveProductHelper {
	...
	{
		if (java.lang.Double.isNaN (dblYield) || java.lang.Double.isNaN (dblTime))
	...
	public static final double DF2Yield (
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblDF) || java.lang.Double.isNaN (dblTime))
	...
	{
		if (java.lang.Double.isNaN (dblValue) || java.lang.Double.isNaN (dblMaturity)) return null;
	...
	public static final java.util.Map<org.drip.analytics.date.JulianDate, java.util.Map<java.lang.String,
		java.lang.Double>> CreateFixingsObject (
			...
			final double dblFix)
	{
		if (null == dtValue || null == bond || java.lang.Double.isNaN (dblFix)) return null;
			...
			final org.drip.param.definition.ComponentMarketParams mktParams)
	{
		if (null == comp || null == valParams || null == period || null == pricerParams || null == mktParams
			|| null == mktParams.getDiscountCurve() || null == mktParams.getCreditCurve() ||
				java.lang.Double.isNaN (dblWorkoutDate) || period.getStartDate() > dblWorkoutDate)
			return null;
	...
	{
		if (null == adblQuotesIn || 0 == adblQuotesIn.length || java.lang.Double.isNaN (dblBump))
			return null;

		double[] adblQuotesOut = new double[adblQuotesIn.length];

		for (int i = 0; i < adblQuotesIn.length; ++i) {
			if (java.lang.Double.isNaN (adblQuotesIn[i])) return null;
