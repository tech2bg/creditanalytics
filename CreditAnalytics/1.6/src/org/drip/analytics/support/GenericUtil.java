...
public class GenericUtil {
	 ...
	 * 
	 * @param dblSpread Double representing the input
	...
	public static final java.lang.String FormatSpreadSimple (
		...
		final double dblMultiplier)
	{
		...
		return df2p.format (dblMultiplier * dblSpread);
	}
	...
	public static final java.lang.String FormatSpreadSimple (
		final double dblSpread)
	{
		return FormatSpreadSimple (dblSpread, 1, 3, 100.);
	}
	...
	public static final java.lang.String FormatSpread (
		final double dblSpread)
	{
		java.text.DecimalFormat df0p = new java.text.DecimalFormat ("#0");

		return df0p.format (10000. * dblSpread);
	}
