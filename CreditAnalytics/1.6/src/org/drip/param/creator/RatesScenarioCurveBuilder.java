...
public class RatesScenarioCurveBuilder {
		...
		final org.drip.product.definition.CalibratableComponent[] aCalibInst)
	{
		...
		try {
			return new org.drip.param.market.RatesCurveScenarioContainer (new
				org.drip.analytics.calibration.RatesCurveScenarioGenerator (strCurrency, aCalibInst));
	...
	{
		org.drip.param.definition.RatesScenarioCurve irsg = FromIRCSG (strCurrency, aCalibInst);
