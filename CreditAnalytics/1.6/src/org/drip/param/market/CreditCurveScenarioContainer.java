...
public class CreditCurveScenarioContainer extends org.drip.param.definition.CreditScenarioCurve {
	...
	{
		if (null == aCalibInst || 0 == aCalibInst.length || java.lang.Double.isNaN (_dblCouponBump =
			dblCouponBump) || java.lang.Double.isNaN (_dblRecoveryBump = dblRecoveryBump) || null == (_ccsg =
				new org.drip.analytics.calibration.CreditCurveScenarioGenerator (aCalibInst)))
		...
		final int iCCScenario)
	{
		if (null == _ccsg || null == dc || null == adblQuotes || 0 == adblQuotes.length ||
			java.lang.Double.isNaN (dblRecovery) || null == astrCalibMeasure || 0 == astrCalibMeasure.length
		...
		final org.drip.param.definition.NodeTweakParams ntpCC)
	{
		if (null == strCustomName || strCustomName.isEmpty() || null == _ccsg || null == dc || null ==
			adblQuotes || 0 == adblQuotes.length || java.lang.Double.isNaN (dblRecovery) || null ==
				astrCalibMeasure || 0 == astrCalibMeasure.length || astrCalibMeasure.length !=
