...
public class BondProductBuilder extends org.drip.service.stream.Serializer {
		...
		final org.drip.param.definition.MarketParams mpc)
	{
		try {
			...
			if (java.lang.Double.isNaN (bpb._dblCoupon = 0.01 * rs.getDouble ("Coupon"))) {
			...
			if (bpb._bIsFloater && java.lang.Double.isNaN (bpb._dblFloatSpread) && (null == bpb._strRateIndex
				|| bpb._strRateIndex.isEmpty())) {
		...
		final org.drip.param.definition.MarketParams mpc)
	{
		...
		if (_bIsFloater && (null == _strRateIndex || _strRateIndex.isEmpty()) && java.lang.Double.isNaN
			(_dblFloatSpread) && java.lang.Double.isNaN (_dblCurrentCoupon)) {
			if (m_bDisplayWarnings)
		...
		if (_bIsFloater && java.lang.Double.isNaN (_dblFloatSpread)) {
			try {
