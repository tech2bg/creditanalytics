...
public class BondRefDataBuilder extends org.drip.service.stream.Serializer implements
		...
		final java.sql.ResultSet rs)
	{
		try {
			...
			if (java.lang.Double.isNaN (brdb._dblCoupon = rs.getDouble ("Coupon"))) return null;

			brdb._dtMaturity = org.drip.analytics.support.AnalyticsHelper.MakeJulianFromRSEntry
				(rs.getDate ("Maturity"));
	...
	public java.lang.String makeSQLInsert()
	{
		...
		if (java.lang.Double.isNaN (_dblIssueAmount))
			sb.append ("null, ");
		else
			sb.append (_dblIssueAmount).append (", ");

		if (java.lang.Double.isNaN (_dblOutstandingAmount))
			sb.append ("null, ");
		else
			sb.append (_dblOutstandingAmount).append (", ");

		if (java.lang.Double.isNaN (_dblMinimumPiece))
			sb.append ("null, ");
		else
			sb.append (_dblMinimumPiece).append (", ");

		if (java.lang.Double.isNaN (_dblMinimumIncrement))
			sb.append ("null, ");
		else
			sb.append (_dblMinimumIncrement).append (", ");

		if (java.lang.Double.isNaN (_dblParAmount))
			sb.append ("null, ");
		else
		...
		if (java.lang.Double.isNaN (_dblCurrentCoupon))
			sb.append ("null, ");
		else
		...
		if (java.lang.Double.isNaN (_dblFloatSpread))
			sb.append ("null, ");
		else
		...
		if (java.lang.Double.isNaN (_dblIssuePrice))
			sb.append ("null, ");
		else
			sb.append (_dblIssuePrice).append (", ");

		if (java.lang.Double.isNaN (_dblCoupon))
			sb.append ("null, ");
		else
