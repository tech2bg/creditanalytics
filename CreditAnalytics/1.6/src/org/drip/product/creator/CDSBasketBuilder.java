...
public class CDSBasketBuilder {
	...
	{
		if (null == dtEffective || null == dtMaturity || java.lang.Double.isNaN (dblCoupon) || null == strIR
			|| strIR.isEmpty() || null == strName || strName.isEmpty() || null == astrCC || 0 ==
				astrCC.length || null == adblWeight || 0 == adblWeight.length || adblWeight.length !=
					astrCC.length)
			return null;
