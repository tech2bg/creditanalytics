...
public class StandardCDXManager {
	...
	private static java.util.Map<java.lang.String, org.drip.param.definition.StandardCDXParams>
		_mapStandardCDXParams = new java.util.HashMap<java.lang.String,
			org.drip.param.definition.StandardCDXParams>();
	...
	{
		try {
			_mapStandardCDXParams.put ("CDX.NA.IG", new org.drip.param.definition.StandardCDXParams (125,
				"USD", 0.01));

			_mapStandardCDXParams.put ("CDX.NA.HY", new org.drip.param.definition.StandardCDXParams (100,
				"USD", 0.05));

			_mapStandardCDXParams.put ("CDX.NA.HVOL", new org.drip.param.definition.StandardCDXParams (30,
				"USD", 0.01));

			_mapStandardCDXParams.put ("CDX.NA.HIVOL", new org.drip.param.definition.StandardCDXParams (30,
				"USD", 0.01));

			_mapStandardCDXParams.put ("CDX.NA.XO", new org.drip.param.definition.StandardCDXParams (35, "USD",
				0.034));

			_mapStandardCDXParams.put ("CDX.NA.HY.BB", new org.drip.param.definition.StandardCDXParams (40,
				"USD", 0.05));

			_mapStandardCDXParams.put ("CDX.NA.HY.B", new org.drip.param.definition.StandardCDXParams (37,
				"USD", 0.05));

			_mapStandardCDXParams.put ("ITRX.EU.IG", new org.drip.param.definition.StandardCDXParams (125,
				"EUR", 0.01));

			_mapStandardCDXParams.put ("ITRAXX.EU.IG", new org.drip.param.definition.StandardCDXParams (125,
				"EUR", 0.01));

			_mapStandardCDXParams.put ("ITRX.EU.HVOL", new org.drip.param.definition.StandardCDXParams (30,
				"EUR", 0.01));

			_mapStandardCDXParams.put ("ITRAXX.EU.HVOL", new org.drip.param.definition.StandardCDXParams (30,
				"EUR", 0.01));

			_mapStandardCDXParams.put ("ITRX.EU.XO", new org.drip.param.definition.StandardCDXParams (50,
				"EUR", 0.05));

			_mapStandardCDXParams.put ("ITRAXX.EU.XO", new org.drip.param.definition.StandardCDXParams (50,
				"EUR", 0.05));

			_mapStandardCDXParams.put ("ITRX.EU.NONFIN", new org.drip.param.definition.StandardCDXParams (50,
				"EUR", 0.05));

			_mapStandardCDXParams.put ("ITRAXX.EU.NONFIN", new org.drip.param.definition.StandardCDXParams (50,
				"EUR", 0.05));

			_mapStandardCDXParams.put ("ITRX.EU.FINSNR", new org.drip.param.definition.StandardCDXParams (20,
				"EUR", 0.01));

			_mapStandardCDXParams.put ("ITRAXX.EU.FINSNR", new org.drip.param.definition.StandardCDXParams (20,
				"EUR", 0.01));

			_mapStandardCDXParams.put ("ITRX.EU.FINSUB", new org.drip.param.definition.StandardCDXParams (20,
				"EUR", 0.01));

			_mapStandardCDXParams.put ("ITRAXX.EU.FINSUB", new org.drip.param.definition.StandardCDXParams (20,
				"EUR", 0.01));
		...
		final java.lang.String strTenor)
	{
		...
		if ("CDX.EM".equalsIgnoreCase (strIndex))
			...
			org.drip.param.definition.StandardCDXParams cdxParams = _mapStandardCDXParams.get (strIndex);
		...
		final java.lang.String strCDXCoverageFile)
	{
		...
		for (java.util.Map.Entry<java.lang.String, org.drip.product.creator.CDXRefDataBuilder> meCDXRefData :
			org.drip.product.creator.CDXRefDataHolder._mapCDXRefData.entrySet()) {
			org.drip.product.creator.CDXRefDataBuilder cdxrdb = meCDXRefData.getValue();
	...
	public static final java.util.Map<java.lang.String, java.lang.String> GetPresetCDXDescriptions()
	{
		...
		for (java.util.Map.Entry<java.lang.String, org.drip.param.definition.StandardCDXParams> meCDXRefData :
