...
public class BondComponent extends org.drip.product.definition.Bond implements
	...
	@Override public boolean isTradeable (
		...
		throws java.lang.Exception
	{
		if (null == valParams) throw new java.lang.Exception ("Null valParams in Bond::isTradeable!");
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblDate) || null == mktParams)
			throw new java.lang.Exception ("Invalid inputs into Bond::calcAccrued");
		...
		for (org.drip.analytics.period.Period period : _periodParams.getPeriods()) {
			...
			if (period.getStartDate() < dblDate)
				return period.getAccrualDCF (dblDate) * dblCoupon * getNotional (period.getStartDate());
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromZC");
		...
		if (null == zc)
			throw new java.lang.Exception ("Cannot create shifted ZC in Bond::calcPriceFromBumpedZC");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromDC");
		...
		org.drip.analytics.definition.DiscountCurve dc = (org.drip.analytics.definition.DiscountCurve)
			mktParams.getDiscountCurve().createParallelShiftedCurve (dblDCBump);

		if (null == dc)
			throw new java.lang.Exception ("Cannot create shifted DC in Bond::calcPriceFromBumpedDC");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromBumpedCC");
		...
		if (null == cc)
			throw new java.lang.Exception ("Cannot create adjusted CC in Bond::calcPriceFromBumpedCC");
			...
			if (s_bBlog)
				System.out.println (org.drip.analytics.date.JulianDate.fromJulian (dblPeriodStart) + "=>" +
					org.drip.analytics.date.JulianDate.fromJulian (period.getEndDate()) + ": " +
						org.drip.analytics.support.GenericUtil.FormatSpreadSimple (dblPVFromCC));
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromYield");
		...
		for (org.drip.analytics.period.Period period : _periodParams.getPeriods()) {
			...
			org.drip.analytics.daycount.ActActDCParams aap = new org.drip.analytics.daycount.ActActDCParams
				(iFrequency, period.getAccrualStartDate(), period.getEndDate());
			...
			if (s_bBlog) {
				System.out.println ("\n" + org.drip.analytics.date.JulianDate.fromJulian (dblAccrualEndDate)
					+ "; DCF=" + org.drip.analytics.support.GenericUtil.FormatSpreadSimple
						(period.getAccrualDCF (dblAccrualEndDate)) + "; Eff Notl=" +
							org.drip.analytics.support.GenericUtil.FormatSpreadSimple
								(getNotional (period.getStartDate(), dblNotionalEndDate)) + "; PV: " +
									org.drip.analytics.support.GenericUtil.FormatSpreadSimple (dblYieldPV));

				System.out.println ("Incremental Cpn PV: " +
					org.drip.analytics.support.GenericUtil.FormatSpreadSimple (dblCouponPV));
			}
			...
			if (s_bBlog) {
				System.out.println (org.drip.analytics.date.JulianDate.fromJulian (period.getStartDate()) +
					"->" + org.drip.analytics.date.JulianDate.fromJulian (dblNotionalEndDate) + "; Notl:" +
						org.drip.analytics.support.GenericUtil.FormatSpreadSimple (getNotional
							(period.getStartDate())) + "->" +
								org.drip.analytics.support.GenericUtil.FormatSpreadSimple (getNotional
				...
				System.out.println ("YF: " + org.drip.analytics.support.GenericUtil.FormatSpreadSimple
		...
		org.drip.analytics.daycount.ActActDCParams aap = new org.drip.analytics.daycount.ActActDCParams
			(iFrequency, valParams._dblValue, dblCashPayDate);
		...
		if (null != quotingParams) {
			...
			aap = new org.drip.analytics.daycount.ActActDCParams (quotingParams._iYieldFrequency,
				valParams._dblValue, dblCashPayDate);
		} else if (null != _mktConv && null != _mktConv._quotingParams) {
			strDC = _mktConv._quotingParams._strYieldDC;
			iFrequency = _mktConv._quotingParams._iYieldFrequency;
			strCalendar = _mktConv._quotingParams._strYieldCalendar;
			...
			aap = new org.drip.analytics.daycount.ActActDCParams (_mktConv._quotingParams._iYieldFrequency,
				valParams._dblValue, dblCashPayDate);
		}
		...
		double dblPV = (((dblYieldPV + dblWorkoutFactor *
			org.drip.analytics.support.AnalyticsHelper.Yield2DF (iFrequency, dblYield,
				dblYearFractWorkout) * getNotional (dblWorkoutDate)) / dblDFCashPay) - dblAccrued);

		if (s_bBlog)
			System.out.println ("Accrued: " + dblAccrued + "; Clean PV: " +
				org.drip.analytics.support.GenericUtil.FormatSpreadSimple (dblPV) + "; PV Scale: " +
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePriceFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromYield");
		...
		return new BondCalibrator (this, false).calibZeroCurveSpreadFromPriceNR (valParams, mktParams,
			quotingParams, dblWorkoutDate, dblWorkoutFactor, calcPriceFromYield (valParams, mktParams,
				quotingParams, dblWorkoutDate, dblWorkoutFactor, dblYield));
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseZSpreadFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseOASFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcBondBasisFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcBondBasisFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseBondBasisFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromYield");
		...
		return new BondCalibrator (this, false).calibrateCreditBasisFromPriceNR (valParams, mktParams,
			dblWorkoutDate, dblWorkoutFactor, calcPriceFromYield (valParams, mktParams, quotingParams,
				dblWorkoutDate, dblWorkoutFactor, dblYield), false);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseCreditBasisFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromYield");
		...
		return new BondCalibrator (this, false).calibrateCreditBasisFromPriceNR (valParams, mktParams,
			dblWorkoutDate, dblWorkoutFactor, calcPriceFromYield (valParams, mktParams, quotingParams,
				dblWorkoutDate, dblWorkoutFactor, dblYield), true);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePECSFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseTSYSpreadFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseGSpreadFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDiscountMarginFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromYield");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromYield");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromYield");
		...
		return (calcPriceFromYield (valParams, mktParams, quotingParams, dblWorkoutDate, dblWorkoutFactor,
			dblYield + 0.0001) + calcPriceFromYield (valParams, mktParams, quotingParams, dblWorkoutDate,
				dblWorkoutFactor, dblYield - 0.0001) - 2. * dblBasePrice) / (dblBasePrice * dblBasePrice);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromYTM");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYield))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromYTM");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYieldFromPrice");
		...
		try {
			return new BondCalibrator (this, true).calibrateYieldFromPriceNR (valParams, mktParams,
				dblWorkoutDate, dblWorkoutFactor, dblPrice);
		} catch (java.lang.Exception e) {
			if (!s_bSuppressErrors) e.printStackTrace();
		}

		return new BondCalibrator (this, true).calibrateYieldFromPrice (valParams, mktParams, dblWorkoutDate,
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYTMFromPrice");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromPrice");
		...
		return new BondCalibrator (this, false).calibZeroCurveSpreadFromPriceNR (valParams, mktParams,
			quotingParams, dblWorkoutDate, dblWorkoutFactor, dblPrice);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseZSpreadFromPrice");

		org.drip.param.valuation.WorkoutInfo wi = calcExerciseYieldFromPrice (valParams, mktParams,
			quotingParams, dblPrice);
		
		if (null == wi)
			throw new java.lang.Exception ("Bond::calcExerciseZSpreadFromPrice - cant calc Work-out info");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseOASFromPrice");

		org.drip.param.valuation.WorkoutInfo wi = calcExerciseYieldFromPrice (valParams, mktParams,
			quotingParams, dblPrice);
		
		if (null == wi)
			throw new java.lang.Exception ("Bond::calcExerciseOASFromPrice - cant calc Work-out info");
	...
	@Override public double calcBondBasisFromPrice (
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || java.lang.Double.isNaN
			(dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN
				(dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcBondBasisFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseBondBasisFromPrice");

		org.drip.param.valuation.WorkoutInfo wi = calcExerciseYieldFromPrice (valParams, mktParams,
			quotingParams, dblPrice);
		
		if (null == wi)
			throw new java.lang.Exception ("Bond::calcExerciseBondBasisFromPrice - cant calc Work-out info");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromPrice");
		...
		return new BondCalibrator (this, false).calibrateCreditBasisFromPriceNR (valParams, mktParams,
			dblWorkoutDate, dblWorkoutFactor, dblPrice, false);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseCreditBasisFromPrice");

		org.drip.param.valuation.WorkoutInfo wi = calcExerciseYieldFromPrice (valParams, mktParams,
			quotingParams, dblPrice);

		if (null == wi)
			throw new java.lang.Exception ("Bond::calcExerciseCreditBasisFromPrice - cant calc Work-out");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromPrice");
		...
		return new BondCalibrator (this, false).calibrateCreditBasisFromPriceNR (valParams, mktParams,
			dblWorkoutDate, dblWorkoutFactor, dblPrice, true);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePECSFromPrice");

		org.drip.param.valuation.WorkoutInfo wi = calcExerciseYieldFromPrice (valParams, mktParams,
			quotingParams, dblPrice);

		if (null == wi)
			throw new java.lang.Exception ("Bond::calcExercisePECSFromPrice - cant calc Work-out");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromPrice");
		...
		throws java.lang.Exception
	{
		...
		if (null == wi)
			throw new java.lang.Exception ("Can't do Work-out for " + _idParams._strISIN +
				" Bond::calcExerciseGSpreadFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromPrice");
		...
		if (null == wi)
			throw new java.lang.Exception ("Can't do Work-out for " + _idParams._strISIN +
				" Bond::calcExerciseISpreadFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDiscountMarginFromPrice");
		...
		if (null == wi)
			throw new java.lang.Exception ("Can't do Work-out for " + _idParams._strISIN +
				" Bond::calcExerciseDiscountMarginFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromPrice");
		...
		if (null == wi)
			throw new java.lang.Exception ("Can't do Work-out for " + _idParams._strISIN +
				" Bond::calcExerciseDurationFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromPrice");
		...
		if (null == wi)
			throw new java.lang.Exception ("Can't do Work-out for " + _idParams._strISIN +
				" Bond::calcExerciseParASWFromPrice");
		...
		final double dblPrice) throws java.lang.Exception
	{
		...
		return (calcPriceFromYield (valParams, mktParams, quotingParams, dblWorkoutDate, dblWorkoutFactor,
			dblYield + 0.0001) + calcPriceFromYield (valParams, mktParams, quotingParams, dblWorkoutDate,
				dblWorkoutFactor, dblYield - 0.0001) - 2. * dblPrice)/ (dblPrice * dblPrice);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromPrice");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPrice))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromPrice");
		...
		if (null == wi)
			throw new java.lang.Exception ("Can't do Work-out for " + _idParams._strISIN +
				" Bond::calcExerciseConvexityFromPrice");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePriceFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcBondBasisFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseBondBasisFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYieldFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseYieldFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseOASFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromZSpread");
		...
		return new BondCalibrator (this, false).calibrateCreditBasisFromPriceNR (valParams, mktParams,
			dblWorkoutDate, dblWorkoutFactor, calcPriceFromBumpedCC (valParams, mktParams, dblWorkoutDate,
				dblWorkoutFactor, 0., false), false);
	}
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseGSpreadFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread) || null == mktParams.getTSYDiscountCurve())
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread) || null == mktParams.getTSYDiscountCurve())
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception
				("Invalid inputs into Bond::calcExerciseDiscountMarginFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromZSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromZSpread");
		...
		return (calcPriceFromZSpread (valParams, mktParams, quotingParams, dblWorkoutDate, dblWorkoutFactor,
			dblZSpread + 0.0001) + calcPriceFromZSpread (valParams, mktParams, quotingParams, dblWorkoutDate,
				dblWorkoutFactor, dblZSpread - 0.0001) - 2. * dblPrice) / (dblPrice * dblPrice);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblZSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromZSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromOAS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePriceFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromOAS");
		...
		return new BondCalibrator (this, false).calibZeroCurveSpreadFromPriceNR (valParams, mktParams,
			quotingParams, dblWorkoutDate, dblWorkoutFactor, calcPriceFromOAS (valParams, mktParams,
				quotingParams, dblWorkoutDate, dblWorkoutFactor, dblOAS));
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseZSpreadFromOAS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcBondBasisFromOAS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseBondBasisFromOAS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYieldFromOAS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseYieldFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseGSpreadFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS) || null == mktParams.getTSYDiscountCurve())
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS) || null == mktParams.getTSYDiscountCurve())
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDiscountMarginFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromOAS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromOAS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromOAS");
		...
		return (calcPriceFromOAS (valParams, mktParams, quotingParams, dblWorkoutDate, dblWorkoutFactor,
			dblOAS + 0.0001) + calcPriceFromOAS (valParams, mktParams, quotingParams, dblWorkoutDate,
				dblWorkoutFactor, dblOAS - 0.0001) - 2. * dblPrice) / (dblPrice * dblPrice);
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblOAS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromOAS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromBondBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePriceFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromBondBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseZSpreadFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblWorkoutDate) ||
			java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromBondBasis");
		...
		/* return new BondCalibrator (this, false).calibDiscCurveSpreadFromPriceNR (valParams, mktParams,
			dblWorkoutDate, dblWorkoutFactor, calcPriceFromBondBasis (valParams, mktParams, quotingParams,
				dblWorkoutDate, dblWorkoutFactor, dblBondBasis)); */
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseOASFromBondBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYieldFromBondBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseYieldFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseGSpreadFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis) || null == mktParams.getTSYDiscountCurve())
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis) || null == mktParams.getTSYDiscountCurve())
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception
				("Invalid inputs into Bond::calcExerciseDiscountMarginFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromBondBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromBondBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromBondBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblBondBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromBondBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePriceFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseZSpreadFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseOASFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYieldFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseYieldFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseBondBasisFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromYieldSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseGSpreadFromYieldSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromYieldSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromYieldSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromYieldSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getTSYDiscountCurve() ||
			java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception
				("Invalid inputs into Bond::calcExerciseDiscountMarginFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromYieldSpread");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblYieldSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromYieldSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromCreditBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePriceFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYieldFromCreditBasis");
		...
		throws java.lang.Exception
	{
		...
		return new BondCalibrator (this, false).calibZeroCurveSpreadFromPriceNR (valParams, mktParams,
			quotingParams, dblWorkoutDate, dblWorkoutFactor, calcPriceFromBumpedCC (valParams, mktParams,
				dblWorkoutDate, dblWorkoutFactor, dblCreditBasis, false));
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromCreditBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseZSpreadFromCreditBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromCreditBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseOASFromCreditBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcBondBasisFromCreditBasis");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseBondBasisFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseTSYSpreadFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseGSpreadFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception
				("Invalid inputs into Bond::calcExerciseDiscountMarginFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPECSFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePECSFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromCreditBasis");
		...
		return (calcPriceFromBumpedCC (valParams, mktParams, dblWorkoutDate, dblWorkoutFactor, 0.0001 +
			dblCreditBasis, false) + calcPriceFromBumpedCC (valParams, mktParams, dblWorkoutDate,
				dblWorkoutFactor, dblCreditBasis - 0.0001, false) - 2. * dblPrice) / (dblPrice * dblPrice);
	}
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblCreditBasis))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromCreditBasis");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcPriceFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExercisePriceFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			...
			throw new java.lang.Exception ("Invalid inputs into Bond::calcYieldFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseYieldFromPECS");
		...
		throws java.lang.Exception
	{
		...
		return new BondCalibrator (this, false).calibZeroCurveSpreadFromPriceNR (valParams, mktParams,
			quotingParams, dblWorkoutDate, dblWorkoutFactor, calcPriceFromBumpedCC (valParams, mktParams,
				dblWorkoutDate, dblWorkoutFactor, dblPECS, true));
	}
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcZSpreadFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseZSpreadFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcOASFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseOASFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcBondBasisFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseBondBasisFromPECS");
	...
	{
		if (null == valParams || null == mktParams || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseYieldSpreadFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseTSYSpreadFromPECS");
		...
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS) || null ==
					mktParams.getTSYDiscountCurve())
			throw new java.lang.Exception ("Invalid inputs into Bond::calcGSpreadFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseGSpreadFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcISpreadFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseISpreadFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDiscountMarginFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDiscountMarginFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcCreditBasisFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseCreditBasisFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcDurationFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseDurationFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcParASWFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseParASWFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN
				(dblWorkoutFactor) || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcConvexityFromPECS");
		...
		return (calcPriceFromBumpedCC (valParams, mktParams, dblWorkoutDate, dblWorkoutFactor, 0.0001 +
			dblPECS, true) + calcPriceFromBumpedCC (valParams, mktParams, dblWorkoutDate, dblWorkoutFactor,
				dblPECS - 0.0001, true) - 2. * dblPrice) / (dblPrice * dblPrice);
	}
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getCreditCurve() || java.lang.Double.isNaN (dblPECS))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcExerciseConvexityFromPECS");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() || null ==
			mktParams.getTSYDiscountCurve() || null == mktParams.getCreditCurve() || java.lang.Double.isNaN
				(dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) || java.lang.Double.isNaN
					(dblGSpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromGSpread");
		...
		if (java.lang.Double.isNaN (dblBmkYield))
			throw new java.lang.Exception ("Cant determine Work-out in Bond::calcTSYSpreadFromGSpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblISpread))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromISpread");
		...
		if (java.lang.Double.isNaN (dblBmkYield))
			throw new java.lang.Exception ("Cant determine Work-out in Bond::calcTSYSpreadFromISpread");
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == mktParams || null == mktParams.getDiscountCurve() ||
			java.lang.Double.isNaN (dblWorkoutDate) || java.lang.Double.isNaN (dblWorkoutFactor) ||
				java.lang.Double.isNaN (dblDiscountMargin))
			throw new java.lang.Exception ("Invalid inputs into Bond::calcTSYSpreadFromDiscountMargin");
		...
		if (java.lang.Double.isNaN (dblBmkYield))
			throw new java.lang.Exception
				("Cant determine Work-out in Bond::calcTSYSpreadFromDiscountMargin");
		...
		throws java.lang.Exception
	{
		...
		return calcPriceFromYield (valParams, mktParams, quotingParams, dblWorkoutDate, dblWorkoutFactor, new
			BondCalibrator (this, false).calibrateYieldFromParASWNR (valParams, mktParams, dblWorkoutDate,
		...
		throws java.lang.Exception
	{
		...
		return new BondCalibrator (this, false).calibrateYieldFromParASWNR (valParams, mktParams,
		...
		throws java.lang.Exception
	{
		...
		return calcZSpreadFromYield (valParams, mktParams, quotingParams, dblWorkoutDate, dblWorkoutFactor,
			new BondCalibrator (this, false).calibrateYieldFromParASWNR (valParams, mktParams,
				dblWorkoutDate, dblWorkoutFactor, dblParASW));
	}
		...
		throws java.lang.Exception
	{
		...
		return calcCreditBasisFromYield (valParams, mktParams, quotingParams, dblWorkoutDate,
			dblWorkoutFactor, new BondCalibrator (this, false).calibrateYieldFromParASWNR (valParams,
				mktParams, dblWorkoutDate, dblWorkoutFactor, dblParASW));
	}
		...
		final double dblPrice)
	{
		...
		if (null == _fltParams) {
			try {
				dblStdZSpread = new BondCalibrator (this, false).calibZeroCurveSpreadFromPriceNR (valParams,
			...
			try {
				dblStdOASpread = new BondCalibrator (this, false).calibDiscCurveSpreadFromPriceNR (valParams,
		...
		try {
			if (null != mktParams.getCreditCurve())
				dblStdCreditBasis = new BondCalibrator (this, false).calibrateCreditBasisFromPriceNR
					(valParams, mktParams, wi._dblDate, wi._dblExerciseFactor, dblPrice, false);
		} catch (java.lang.Exception e) {
			if (!s_bSuppressErrors) e.printStackTrace();
		}
		...
		try {
			if (null != mktParams.getCreditCurve())
				dblStdPECS = new BondCalibrator (this, false).calibrateCreditBasisFromPriceNR (valParams,
					mktParams, wi._dblDate, wi._dblExerciseFactor, dblPrice, true);
		} catch (java.lang.Exception e) {
			if (!s_bSuppressErrors) e.printStackTrace();
		}
	...
	public class BondCalibrator {
		...
		/*
		 * Root by Bracketing method
		 */

		private int BRACKET_SECANT = 0;
		private int BRACKET_BISECTION = 1;
		// private int BRACKET_COMPOSITE = 2;
		private double BRACKET_COMPOSITE_BISECTION_WEIGHT = 0.73266144;

		private int _iMaxIterations = 500;
		private double _dblCalibFloor = 100.;
		private java.util.Random rand = null;
		private double _dblCalibCeiling = -1.8;
		private double _dblRelTolerance = 1.e-06;
		private int _iBracketMethod = BRACKET_BISECTION;

		/*
		 * Root by Newton Raphson method
		 */

		// Yield Calibration Stochastic Control

		private double _dblYieldInit = 0.05;
		private int _iNumYieldIterations = 100;
		private double _dblYieldIncr = 0.0001;
		private double _dblYieldDiffTol = 0.000001;

		// Z Spread Calibration Stochastic Control

		private double _dblZSpreadInit = 0.01;
		private int _iNumZSpreadIterations = 50;
		private double _dblZSpreadIncr = 0.0001;
		private double _dblZSpreadDiffTol = 0.0001;

		// Credit Basis Calibration Stochastic Control

		private double _dblCreditBasisInit = 0.01;
		private int _iNumCreditBasisIterations = 50;
		private double _dblCreditBasisIncr = 0.0001;
		private double _dblCreditBasisDiffTol = 0.0001;
			...
			final double dblValueRight)
		{
			...
			double dblBisectionWeight = BRACKET_COMPOSITE_BISECTION_WEIGHT;

			if (null != rand) dblBisectionWeight = rand.nextDouble();

			return (1. - dblBisectionWeight) * (dblLeft + ((dblLeft - dblRight) / (dblValueRight -
				dblValueLeft) * dblValueLeft) + dblBisectionWeight * (dblLeft + dblRight));
		}
		 ...
		 * 
		 * @param bond Parent
		 * @param bRandBracket Flag indicator if the bracketing converger is randomly chosen
		 * 
		...
		public BondCalibrator (
			...
			final boolean bRandBracket)
			throws java.lang.Exception
		{
			if (null == (_bond = bond))
				throw new java.lang.Exception ("No NULL bond into BondCalibrator ctr");

			if (bRandBracket) rand = new java.util.Random();
		}

		/**
		 * Calibrates the bond yield from the market price using the root bracketing technique.
		 * 
		 * @param valParams VauationParams
		 * @param mktParams Bond Market Params
			...
			throws java.lang.Exception
		{
			...
			double dblPriceDiff = 0.;
			double dblYieldLeft = _dblCalibFloor;
			double dblYieldRight = _dblCalibCeiling;

			double dblAbsTolerance = java.lang.Math.abs (_dblRelTolerance * dblPrice);

			if (dblAbsTolerance < _dblRelTolerance) dblAbsTolerance = _dblRelTolerance;

			double dblPriceDiffLeft = _bond.calcPriceFromYield (valParams, mktParams, null, dblWorkoutDate,
				dblWorkoutFactor, dblYieldLeft) - dblPrice;

			if (java.lang.Double.isNaN (dblPriceDiffLeft))
				throw new java.lang.Exception ("Floor " + _dblCalibFloor + " produces NaN!");

			if (java.lang.Math.abs (dblPriceDiffLeft) <= dblAbsTolerance) return dblYieldLeft;

			double dblPriceDiffRight = _bond.calcPriceFromYield (valParams, mktParams, null, dblWorkoutDate,
				dblWorkoutFactor, dblYieldRight) - dblPrice;

			if (java.lang.Double.isNaN (dblPriceDiffRight))
				throw new java.lang.Exception ("Ceiling " + _dblCalibCeiling + " produces NaN!");

			if (java.lang.Math.abs (dblPriceDiffRight) <= dblAbsTolerance) return dblYieldRight;

			if (0 < dblPriceDiffLeft * dblPriceDiffRight)
				throw new java.lang.Exception ("Cannot bracket the root!");

			double dblYield = getNextRoot (dblYieldLeft, dblYieldRight, dblPriceDiffLeft, dblPriceDiffRight);

			while (java.lang.Math.abs (dblPriceDiff = _bond.calcPriceFromYield (valParams, mktParams, null,
				dblWorkoutDate, dblWorkoutFactor, dblYield) - dblPrice) > dblAbsTolerance) {
				if (++iNumIterations >= _iMaxIterations)
					throw new java.lang.Exception ("Cannot calibrate " + _bond.getComponentName() +
						" within limit!");

				if (java.lang.Double.isNaN (dblPriceDiff))
					throw new java.lang.Exception (dblYield + " produces NaN!");

				if (dblPriceDiff < 0) {
					dblYieldLeft = dblYield;
					dblPriceDiffLeft = dblPriceDiff;
				} else {
					dblYieldRight = dblYield;
					dblPriceDiffRight = dblPriceDiff;
				}

				dblYield = getNextRoot (dblYieldLeft, dblYieldRight, dblPriceDiffLeft, dblPriceDiffRight);
			}
		...
		public double calibrateYieldFromPriceNR (
			final org.drip.param.valuation.ValuationParams valParams,
			final org.drip.param.definition.ComponentMarketParams mktParams,
			final double dblWorkoutDate,
			final double dblWorkoutFactor,
			...
			throws java.lang.Exception
		{
			double dblYieldPrev = _dblYieldInit;

			double dblPrice = _bond.calcPriceFromYield (valParams, mktParams, null, dblWorkoutDate,
				dblWorkoutFactor, dblYieldPrev);

			if (s_bBlog) System.out.println ("Price[" + dblYieldPrev + "]=" + dblPrice);

			double dblDYDP = _dblYieldIncr / (_bond.calcPriceFromYield (valParams, mktParams, null,
				dblWorkoutDate, dblWorkoutFactor, dblYieldPrev + _dblYieldIncr) - dblPrice);

			if (s_bBlog) System.out.println ("DYDP[" + dblYieldPrev + "]=" + dblDYDP);

			double dblYield = dblYieldPrev + dblDYDP * (dblPriceCalib - dblPrice);

			if (s_bBlog) System.out.println ("Yield[" + dblDYDP + "]=" + dblYield);

			if (java.lang.Double.isNaN (dblYield) || java.lang.Double.NEGATIVE_INFINITY == dblYield ||
				java.lang.Double.POSITIVE_INFINITY == dblYield)
				throw new java.lang.Exception ("Got " + dblYield + " for yield for " +
					_bond.getComponentName() + " and price " + dblPrice);

			while (_dblYieldDiffTol < java.lang.Math.abs (dblYield - dblYieldPrev)) {
				if (0 == --_iNumYieldIterations)
					throw new java.lang.Exception ("Cannot calib yield for " + _bond.getComponentName() +
						" and price " + dblPriceCalib + " within limit!");

				dblYieldPrev = dblYield;

				dblPrice = _bond.calcPriceFromYield (valParams, mktParams, null, dblWorkoutDate,
					dblWorkoutFactor, dblYield);

				if (s_bBlog) System.out.println ("Price[" + dblYieldPrev + "]=" + dblPrice);

				dblDYDP = _dblYieldIncr / (_bond.calcPriceFromYield (valParams, mktParams, null,
					dblWorkoutDate, dblWorkoutFactor, dblYield + _dblYieldIncr) - dblPrice);

				if (s_bBlog) System.out.println ("DYDP[" + dblYieldPrev + "]=" + dblDYDP);

				dblYield = dblYieldPrev + dblDYDP * (dblPriceCalib - dblPrice);
			...
			throws java.lang.Exception
		{
			...
			int iNumIterations = 0;
			double dblPriceDiff = 0.;
			double dblZSpreadLeft = _dblCalibFloor;
			double dblZSpreadRight = _dblCalibCeiling;

			double dblAbsTolerance = java.lang.Math.abs (_dblRelTolerance * dblPrice);

			if (dblAbsTolerance < _dblRelTolerance) dblAbsTolerance = _dblRelTolerance;

			double dblPriceDiffLeft = _bond.calcPriceFromBumpedDC (valParams, mktParams, dblWorkoutDate,
				dblWorkoutFactor, dblZSpreadLeft) - dblPrice;

			if (java.lang.Math.abs (dblPriceDiffLeft) <= dblAbsTolerance) return dblZSpreadLeft;

			double dblPriceDiffRight = _bond.calcPriceFromBumpedDC (valParams, mktParams, dblWorkoutDate,
				dblWorkoutFactor, dblZSpreadRight) - dblPrice;

			if (java.lang.Math.abs (dblPriceDiffRight) <= dblAbsTolerance) return dblZSpreadRight;

			if (0 < dblPriceDiffLeft * dblPriceDiffRight)
				throw new java.lang.Exception ("Cannot bracket the root!");

			double dblZSpread = getNextRoot (dblZSpreadLeft, dblZSpreadRight, dblPriceDiffLeft,
				dblPriceDiffRight);

			while (java.lang.Math.abs (dblPriceDiff = _bond.calcPriceFromBumpedDC (valParams, mktParams,
				dblWorkoutDate, dblWorkoutFactor, dblZSpread) - dblPrice) > dblAbsTolerance) {
				if (++iNumIterations >= _iMaxIterations)
					throw new java.lang.Exception ("Cannot calibrate within limit!");

				if (dblPriceDiff < 0) {
					dblZSpreadLeft = dblZSpread;
					dblPriceDiffLeft = dblPriceDiff;
				} else {
					dblZSpreadRight = dblZSpread;
					dblPriceDiffRight = dblPriceDiff;
				}

				dblZSpread = getNextRoot (dblZSpreadLeft, dblZSpreadRight, dblPriceDiffLeft,
					dblPriceDiffRight);
			}
		...
		public double calibrateZSpreadFromPrice2 (
			final org.drip.param.valuation.ValuationParams valParams,
			final org.drip.param.definition.ComponentMarketParams mktParams,
			final org.drip.param.valuation.QuotingParams quotingParams,
			final double dblWorkoutDate,
			...
			throws java.lang.Exception
		{
			...
			double dblPriceDiffLeft = _bond.calcPriceFromBumpedZC (valParams, mktParams, quotingParams,
				dblWorkoutDate, dblWorkoutFactor, dblZSpreadLeft) - dblPrice;

			if (java.lang.Math.abs (dblPriceDiffLeft) <= dblAbsTolerance) return dblZSpreadLeft;

			double dblPriceDiffRight = _bond.calcPriceFromBumpedZC (valParams, mktParams, quotingParams,
				dblWorkoutDate, dblWorkoutFactor, dblZSpreadRight) - dblPrice;
			...
			while (java.lang.Math.abs (dblPriceDiff = _bond.calcPriceFromBumpedZC (valParams, mktParams,
				quotingParams, dblWorkoutDate, dblWorkoutFactor, dblZSpread) - dblPrice) > dblAbsTolerance) {
				if (++iNumIterations >= _iMaxIterations)
					throw new java.lang.Exception ("Cannot calibrate within limit!");
		...
		/**
		 * Calibrates the bond Z Spread from the market price using the Newton-Raphson technique. Calibration
		 * 		is done by bumping the discount curve.
		 * 
		 * @param valParams VauationParams
		 * @param mktParams Bond Market Params
		 * @param dblWorkoutDate JulianDate Work-out
		...
		public double calibDiscCurveSpreadFromPriceNR (
			final org.drip.param.valuation.ValuationParams valParams,
			final org.drip.param.definition.ComponentMarketParams mktParams,
			final double dblWorkoutDate,
			final double dblWorkoutFactor,
			...
			throws java.lang.Exception
		{
			...
			double dblZSpreadPrev = _dblZSpreadInit;

			double dblPrice = _bond.calcPriceFromBumpedDC (valParams, mktParams, dblWorkoutDate,
				dblWorkoutFactor, dblZSpreadPrev);

			double dblDZDP = _dblZSpreadIncr / (_bond.calcPriceFromBumpedDC (valParams, mktParams,
				dblWorkoutDate, dblWorkoutFactor, dblZSpreadPrev + _dblZSpreadIncr) - dblPrice);

			double dblZSpread = dblZSpreadPrev + dblDZDP * (dblPriceCalib - dblPrice);

			if (java.lang.Double.isNaN (dblZSpread) || java.lang.Double.NEGATIVE_INFINITY == dblZSpread ||
				java.lang.Double.POSITIVE_INFINITY == dblZSpread)
				throw new java.lang.Exception ("Get " + dblZSpread + " for z for " + _bond.getComponentName()
					+ " and price " + dblPrice + " within limit; FRN = " + (null != _fltParams));

			while (_dblZSpreadDiffTol < java.lang.Math.abs (dblZSpread - dblZSpreadPrev)) {
				if (0 == --_iNumZSpreadIterations)
					throw new java.lang.Exception ("Cannot calib z spread for " + _bond.getComponentName() +
						" and price " + dblPriceCalib + " within limit; FRN = " + (null != _fltParams));

				dblZSpreadPrev = dblZSpread;

				dblPrice = _bond.calcPriceFromBumpedDC (valParams, mktParams, dblWorkoutDate,
					dblWorkoutFactor, dblZSpread);

				dblDZDP = _dblZSpreadIncr / (_bond.calcPriceFromBumpedDC (valParams, mktParams,
					dblWorkoutDate, dblWorkoutFactor, dblZSpread + _dblZSpreadIncr) - dblPrice);

				dblZSpread = dblZSpreadPrev + dblDZDP * (dblPriceCalib - dblPrice);

				if (java.lang.Double.isNaN (dblZSpread) || java.lang.Double.NEGATIVE_INFINITY == dblZSpread
					|| java.lang.Double.POSITIVE_INFINITY == dblZSpread)
					throw new java.lang.Exception ("Got " + dblZSpread + " for z for " +
						_bond.getComponentName() + " and price " + dblPrice + "; FRN = " + (null !=
							_fltParams));
			}
		...
		/**
		 * Calibrates the bond Z Spread from the market price using the Newton-Raphson technique. Calibration
		 * 		is done by bumping the Zero Curve.
		 * 
		 * @param valParams VauationParams
		 * @param mktParams Bond Market Params
		 * @param quotingParams Quoting Parameters
		...
		public double calibZeroCurveSpreadFromPriceNR (
			final org.drip.param.valuation.ValuationParams valParams,
			final org.drip.param.definition.ComponentMarketParams mktParams,
			final org.drip.param.valuation.QuotingParams quotingParams,
			final double dblWorkoutDate,
			...
			throws java.lang.Exception
		{
			...
			double dblPrice = _bond.calcPriceFromBumpedZC (valParams, mktParams, quotingParams,
				dblWorkoutDate, dblWorkoutFactor, dblZSpreadPrev);

			double dblDZDP = _dblZSpreadIncr / (_bond.calcPriceFromBumpedZC (valParams, mktParams,
				quotingParams, dblWorkoutDate, dblWorkoutFactor, dblZSpreadPrev + _dblZSpreadIncr) -
					dblPrice);
			...
			while (_dblZSpreadDiffTol < java.lang.Math.abs (dblZSpread - dblZSpreadPrev)) {
				...
				dblPrice = _bond.calcPriceFromBumpedZC (valParams, mktParams, quotingParams, dblWorkoutDate,
					dblWorkoutFactor, dblZSpread);

				dblDZDP = _dblZSpreadIncr / (_bond.calcPriceFromBumpedZC (valParams, mktParams,
					quotingParams, dblWorkoutDate, dblWorkoutFactor, dblZSpread + _dblZSpreadIncr) -
						dblPrice);
		...
		public double calibrateCreditBasisFromPriceNR (
			final org.drip.param.valuation.ValuationParams valParams,
			final org.drip.param.definition.ComponentMarketParams mktParams,
			final double dblWorkoutDate,
			final double dblWorkoutFactor,
			...
			throws java.lang.Exception
		{
			double dblCreditBasisPrev = _dblCreditBasisInit;

			double dblPrice = _bond.calcPriceFromBumpedCC (valParams, mktParams, dblWorkoutDate,
				dblWorkoutFactor, dblCreditBasisPrev, bFlatCalib);

			double dblDCreditBasisDP = _dblCreditBasisIncr / (_bond.calcPriceFromBumpedCC (valParams,
				mktParams, dblWorkoutDate, dblWorkoutFactor, dblCreditBasisPrev + _dblCreditBasisIncr,
					bFlatCalib) - dblPrice);

			double dblCreditBasis = dblCreditBasisPrev + dblDCreditBasisDP * (dblPriceCalib - dblPrice);

			/* System.out.println (dblCreditBasis + "|" + dblCreditBasisPrev + "; " + dblPriceCalib + "|" +
				dblPrice); */

			if (java.lang.Double.isNaN (dblCreditBasis) || java.lang.Double.NEGATIVE_INFINITY ==
				dblCreditBasis || java.lang.Double.POSITIVE_INFINITY == dblCreditBasis)
				throw new java.lang.Exception ("Get " + dblCreditBasis + " for Credit Basis for " +
					_bond.getComponentName() + " and price " + dblPrice + " within limit!");

			while (_dblCreditBasisDiffTol < java.lang.Math.abs (dblCreditBasis - dblCreditBasisPrev)) {
				if (0 == --_iNumCreditBasisIterations)
					throw new java.lang.Exception ("Cannot calib credit basis for " +
						_bond.getComponentName() + " and price " + dblPriceCalib + " within limit!");

				dblCreditBasisPrev = dblCreditBasis;

				dblPrice = _bond.calcPriceFromBumpedCC (valParams, mktParams, dblWorkoutDate,
					dblWorkoutFactor, dblCreditBasis, bFlatCalib);

				dblDCreditBasisDP = _dblCreditBasisIncr / (_bond.calcPriceFromBumpedCC (valParams, mktParams,
					dblWorkoutDate, dblWorkoutFactor, dblCreditBasis + _dblCreditBasisIncr, bFlatCalib) -
						dblPrice);

				dblCreditBasis = dblCreditBasisPrev + dblDCreditBasisDP * (dblPriceCalib - dblPrice);

				if (java.lang.Double.isNaN (dblCreditBasis) || java.lang.Double.NEGATIVE_INFINITY ==
					dblCreditBasis || java.lang.Double.POSITIVE_INFINITY == dblCreditBasis)
					throw new java.lang.Exception ("Got " + dblCreditBasis + " for credit basis for " +
						_bond.getComponentName() + " and price " + dblPrice);
			}

			return dblCreditBasis;
		}
		...
		public double calibrateYieldFromParASWNR (
			final org.drip.param.valuation.ValuationParams valParams,
			final org.drip.param.definition.ComponentMarketParams mktParams,
			final double dblWorkoutDate,
			final double dblWorkoutFactor,
			...
			throws java.lang.Exception
		{
			...
			double dblParASW = _bond.calcParASWFromYield (valParams, mktParams, null, dblWorkoutDate,
				dblWorkoutFactor, dblYieldPrev);

			double dblDYDParASW = _dblYieldIncr / (_bond.calcParASWFromYield (valParams, mktParams, null,
				dblWorkoutDate, dblWorkoutFactor, dblYieldPrev + _dblYieldIncr) - dblParASW);

			double dblYield = dblYieldPrev + dblDYDParASW * (dblParASWCalib - dblParASW);

			if (java.lang.Double.isNaN (dblYield) || java.lang.Double.NEGATIVE_INFINITY == dblYield ||
				java.lang.Double.POSITIVE_INFINITY == dblYield) {
				if (s_bSuppressErrors)
					System.out.println ("Got " + dblYield + " for yield for " + _bond.getComponentName() +
						" and par ASW " + dblParASW);

				throw new java.lang.Exception ("Got " + dblYield + " for yield for " +
					_bond.getComponentName() + " and par ASW " + dblParASW);
				}

			while (_dblYieldDiffTol < java.lang.Math.abs (dblYield - dblYieldPrev)) {
				if (0 == --_iNumYieldIterations)
					throw new java.lang.Exception ("Cannot calib yield for " + _bond.getComponentName() +
						" and par ASW " + dblParASWCalib + " within limit!");

				dblYieldPrev = dblYield;

				dblParASW = _bond.calcParASWFromYield (valParams, mktParams, null, dblWorkoutDate,
					dblWorkoutFactor, dblYield);

				dblDYDParASW = _dblYieldIncr / (_bond.calcParASWFromYield (valParams, mktParams, null,
					dblWorkoutDate, dblWorkoutFactor, dblYield + _dblYieldIncr) - dblParASW);

				dblYield = dblYieldPrev + dblDYDParASW * (dblParASWCalib - dblParASW);
