...
public class CDSBasket extends org.drip.product.definition.BasketProduct {
	...
	{
		if (null == dtEffective || null == dtMaturity || java.lang.Double.isNaN (dblCoupon) || null == aComp
			|| 0 == aComp.length || null == adblWeight || 0 == adblWeight.length || aComp.length !=
				adblWeight.length || null == strName || strName.isEmpty())
