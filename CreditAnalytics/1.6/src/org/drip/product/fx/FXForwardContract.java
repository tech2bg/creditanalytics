...
public class FXForwardContract extends org.drip.product.definition.FXForward {
	...
	@Override public double implyFXForward (
		...
		throws java.lang.Exception
	{
		if (null == valParams || null == dcNum || null == dcDenom || java.lang.Double.isNaN (dblFXSpot))
	...
	public class FXBasisCalibrator {
		...
		public double calibrateDCBasisFromFwdPriceNR (
			...
			throws java.lang.Exception
		{
			if (null == valParams || null == dcNum || null == dcDenom || java.lang.Double.isNaN
				(dblMarketFXFwdPrice) || java.lang.Double.isNaN (dblFXSpot))
			...
			if (java.lang.Double.isNaN (dblFXFwdBase))
			...
			if (java.lang.Double.isNaN (dblFXFwdBumped))
			...
			if (java.lang.Double.isNaN (dblDBasisDFXFwd))
			...
			if (java.lang.Double.isNaN (dblBasis) || java.lang.Double.NEGATIVE_INFINITY == dblBasis ||
				java.lang.Double.POSITIVE_INFINITY == dblBasis)
			...
			while (_dblBasisDiffTol < java.lang.Math.abs (dblBasis - dblBasisPrev)) {
				...
				if (java.lang.Double.isNaN (dblFXFwdBase = calcFXFwd (valParams, dcNum, dcDenom, dblFXSpot,
					dblBasisPrev = dblBasis, bBasisOnDenom)))
					throw new java.lang.Exception ("Cannot imply FX Fwd for " + dblBasis + " shift!");

				if (java.lang.Double.isNaN (dblFXFwdBumped = calcFXFwd (valParams, dcNum, dcDenom, dblFXSpot,
					dblBasis + _dblBasisIncr, bBasisOnDenom)))
					throw new java.lang.Exception ("Cannot imply FX Fwd for " + (dblBasis + _dblBasisIncr) +
						" shift!");

				if (java.lang.Double.isNaN (dblDBasisDFXFwd = _dblBasisIncr / (dblFXFwdBumped -
					dblFXFwdBase)))
