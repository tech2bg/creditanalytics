...
public class CouponSetting extends org.drip.service.stream.Serializer implements
	...
	public double processCouponWindow (
		...
		throws java.lang.Exception
	{
		if (java.lang.Double.isNaN (dblCoupon) || java.lang.Double.isNaN (dblDate))
			throw new java.lang.Exception ("Invalid params into CouponSetting.processCouponWindow");

		if (java.lang.Double.isNaN (_dblCouponCeiling) && java.lang.Double.isNaN (_dblCouponFloor))
			return dblCoupon;

		if (!java.lang.Double.isNaN (_dblCouponCeiling) && dblCoupon > _dblCouponCeiling)
			return _dblCouponCeiling;

		if (!java.lang.Double.isNaN (_dblCouponFloor) && dblCoupon < _dblCouponFloor)
	...
	{
		if (java.lang.Double.isNaN (_dblCoupon)) return false;

		if (null == _fsCoupon) _fsCoupon = FactorSchedule.CreateBulletSchedule();

		if (!java.lang.Double.isNaN (_dblCouponCeiling) && !java.lang.Double.isNaN (_dblCouponFloor) &&
			_dblCouponCeiling < _dblCouponFloor)
			return false;
		...
		throws java.lang.Exception
	{
		...
		CouponSetting bcp = new CouponSetting (fs, "FULL", 0.05, java.lang.Double.NaN,
