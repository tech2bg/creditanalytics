...
public class FloaterSetting extends org.drip.service.stream.Serializer implements
	...
	{
		if (java.lang.Double.isNaN (_dblFloatSpread) && java.lang.Double.isNaN (_dblCurrentCoupon))
			return false;

		if (java.lang.Double.isNaN (_dblCurrentCoupon) && (null == _strRateIndex || _strRateIndex.isEmpty()))
			return false;
