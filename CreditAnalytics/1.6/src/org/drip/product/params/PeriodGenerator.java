...
public class PeriodGenerator extends PeriodSet {
	...
	{
		if (java.lang.Double.isNaN (_dblEffective) || java.lang.Double.isNaN (_dblMaturity)) return false;

		if (null == _dapPay)
			_dapPay = new org.drip.analytics.daycount.DateAdjustParams
				(org.drip.analytics.daycount.Convention.DR_FOLL, "USD");

		if (null == _dapAccrualEnd)
			_dapAccrualEnd = new org.drip.analytics.daycount.DateAdjustParams
				(org.drip.analytics.daycount.Convention.DR_FOLL, "USD");

		if (null == _dapAccrualStart)
			_dapAccrualStart = new org.drip.analytics.daycount.DateAdjustParams
				(org.drip.analytics.daycount.Convention.DR_FOLL, "USD");
...
-						_dblMaturity, // Maturity
		...
		if (!java.lang.Double.isNaN (_dblFirstCouponDate))
			_lPeriods.get (0).setPayDate (_dblFirstCouponDate);

		if (!java.lang.Double.isNaN (_dblInterestAccrualStart))
