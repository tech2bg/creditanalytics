		...
		final java.lang.String strCurrency)
	{
		...
		try {
			if (!(irscTSY = org.drip.param.creator.RatesScenarioCurveBuilder.FromIRCSG (strCurrency + "TSY",
				aCompCalib)).cookScenarioDC (new org.drip.param.valuation.ValuationParams (dt, dt.addBusDays
					(3, strCurrency), strCurrency), null, null, adblCompCalibValue, 0.0001, astrCalibMeasure,
						mpc.getFixings(), null, 15)) {
