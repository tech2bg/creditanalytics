...
/**
 * This class holds the tick related component parameters - it contains the product ID, the quote composite,
...
public class ComponentTickQuote extends org.drip.service.stream.Serializer {
		...
		throws java.lang.Exception
	{
		...
		System.out.println (new java.lang.String (abCTQ));

		ComponentTickQuote ctqDeser = (ComponentTickQuote) ctq.deserialize (abCTQ);

		System.out.println (new java.lang.String (ctqDeser.serialize()));
	}
}
