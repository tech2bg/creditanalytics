...
/**
 *  Class holds the requests for the Credit Analytics server from the client, onto the server.
 * 
...
public class CreditAnalyticsRequest extends org.drip.service.stream.Serializer {
		...
		throws java.lang.Exception
	{
		...
		_strID = org.drip.analytics.support.GenericUtil.GUID();
	}
	...
	@Override public byte[] serialize()
	{
		...
		sb.append (_strID + getFieldDelimiter());

		if (null == _comp)
			sb.append (org.drip.service.stream.Serializer.NULL_SER_STRING + getFieldDelimiter());
		else
			sb.append (new java.lang.String (_comp.serialize()) + getFieldDelimiter());

		if (null == _valParams)
			sb.append (org.drip.service.stream.Serializer.NULL_SER_STRING + getFieldDelimiter());
		else
			sb.append (new java.lang.String (_valParams.serialize()) + getFieldDelimiter());

		if (null == _pricerParams)
			sb.append (org.drip.service.stream.Serializer.NULL_SER_STRING + getFieldDelimiter());
		else
			sb.append (new java.lang.String (_pricerParams.serialize()) + getFieldDelimiter());

		if (null == _cmp)
			sb.append (org.drip.service.stream.Serializer.NULL_SER_STRING + getFieldDelimiter());
		else
			sb.append (new java.lang.String (_cmp.serialize()) + getFieldDelimiter());
	...
	public static org.drip.param.market.ComponentMarketParamSet MakeCMP()
		throws java.lang.Exception
	{
		double dblStart = org.drip.analytics.date.JulianDate.Today().getJulian();
