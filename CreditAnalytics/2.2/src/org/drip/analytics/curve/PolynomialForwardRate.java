...
/**
 * This class contains the polynomial forward rate based discount curve holder object. The class constructs
 *  the discount curve using generic polynomial splines (arbitrary degree, variable shape control, custom
 *  segment knot constraints, user specified variational penalty optimization, and segment tension). It
...
public class PolynomialForwardRate extends org.drip.analytics.definition.DiscountCurve {
		...
		throws java.lang.Exception
	{
		...
		java.lang.String[] astrField = org.drip.math.common.StringUtil.Split (strSerializedCubicForwardRate,
			getFieldDelimiter());
