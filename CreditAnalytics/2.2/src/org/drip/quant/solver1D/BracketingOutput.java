...
public class BracketingOutput extends org.drip.quant.solver1D.ExecutionInitializationOutput {
	...
	public org.drip.quant.solver1D.ConvergenceOutput makeConvergenceVariate()
	{
		org.drip.quant.solver1D.ConvergenceOutput cop = null;

		try {
			cop = new org.drip.quant.solver1D.ConvergenceOutput (this);
