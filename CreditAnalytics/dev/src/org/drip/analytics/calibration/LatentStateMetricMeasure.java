...
public class LatentStateMetricMeasure {
	 ...
	 * 
	 * @param strLatentState Name of the Hidden State
		...
		throws java.lang.Exception
	{
		if (null == (_strLatentState = strLatentState) || _strLatentState.isEmpty() || null ==
			(_strQuantificationMetric = strQuantificationMetric) || _strQuantificationMetric.isEmpty() ||
				null == (_strManifestMeasure = strManifestMeasure) || _strManifestMeasure.isEmpty() ||
	...
	public java.lang.String getLatentState()
	{
