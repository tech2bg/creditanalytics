...
/**
 * This class contains the hyperbolic tension forward rate based discount curve holder object. The class
 * 	constructs the discount curve using generic hyperbolic tension splines (arbitrary degree, variable shape
 *  control, custom segment knot constraints, user specified variational penalty optimization, and segment
 *  tension). It exports the following functionality:
