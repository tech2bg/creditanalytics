...
/**
 * This class contains the polynomial spline discount factor based discount curve holder object. The class
 * 	constructs the discount curve using generic polynomial splines (arbitrary degree, variable shape control,
 *  custom segment knot constraints, user specified variational penalty optimization, and segment tension).
