...
public class BracketingOutput extends org.drip.function.solver1D.ExecutionInitializationOutput {
	...
	public org.drip.function.solver1D.ConvergenceOutput makeConvergenceVariate()
	{
		org.drip.function.solver1D.ConvergenceOutput cop = null;

		try {
			cop = new org.drip.function.solver1D.ConvergenceOutput (this);
