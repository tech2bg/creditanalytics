...
public class ExecutionInitializer {
	...
	private org.drip.function.solver1D.ConvergenceControlParams _ccp = null;
	...
	private StartingVariateOF validateVariate (
		final double dblVariate,
		final org.drip.function.solver1D.BracketingOutput bop)
	{
		...
		final org.drip.function.solver1D.BracketingOutput bop)
	{
			...
			if (org.drip.quant.common.NumberUtil.IsValid (dblVariatePrev) &&
				...
				try {
					bop.done (dblVariatePrev, dblVariate, dblOFPrev, dblOF,
						org.drip.function.solver1D.VariateIteratorPrimitive.Bisection (dblVariatePrev,
							dblVariate));
				} catch (java.lang.Exception e) {
				}
		...
		try {
			bop.done (dblVariateLeft, dblVariateRight, dblOFLeft, dblOFRight,
				org.drip.function.solver1D.VariateIteratorPrimitive.Bisection (dblVariateLeft, dblVariateRight));
		} catch (java.lang.Exception e) {
		}
	...
	private boolean isInConvergenceZone (
		...
		final double dblOFGoal,
		final org.drip.function.solver1D.ConvergenceOutput cop)
		throws java.lang.Exception
	{
		if (!cop.incrOFCalcs())
	...
	private double getStartingBracketVariate (
		final org.drip.function.solver1D.BracketingControlParams bcp,
		final org.drip.function.solver1D.InitializationHeuristics ih)
	{
	...
	public ExecutionInitializer (
		...
		final org.drip.function.solver1D.ConvergenceControlParams ccp,
		...
		throws java.lang.Exception
	{
		...
		if (null == (_ccp = ccp)) _ccp = new org.drip.function.solver1D.ConvergenceControlParams();
	...
	public org.drip.function.solver1D.BracketingOutput initializeBracket (
		final org.drip.function.solver1D.InitializationHeuristics ih,
		final double dblOFGoal)
	{
		org.drip.function.solver1D.BracketingControlParams bcp = (null != ih && null != ih.getCustomBCP()) ?
			ih.getCustomBCP() : new org.drip.function.solver1D.BracketingControlParams();

		int iNumExpansions = bcp.getNumExpansions();

		org.drip.function.solver1D.BracketingOutput bop = new org.drip.function.solver1D.BracketingOutput();
	...
	public org.drip.function.solver1D.ConvergenceOutput initializeVariate (
		final org.drip.function.solver1D.InitializationHeuristics ih,
		final double dblOFGoal)
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (dblOFGoal)) return null;

		org.drip.function.solver1D.ConvergenceOutput cop = new org.drip.function.solver1D.ConvergenceOutput();

		org.drip.function.solver1D.BracketingOutput bop = initializeBracket (ih, dblOFGoal);
	...
	public org.drip.function.solver1D.BracketingOutput verifyHardSearchEdges (
		final org.drip.function.solver1D.InitializationHeuristics ih,
		final double dblOFGoal)
	{
