...
public class FixedPointFinderZheng extends org.drip.function.solver1D.FixedPointFinderBracketing {
	...
	{
		double dblVariateMid = org.drip.function.solver1D.VariateIteratorPrimitive.Bisection (dblCurrentVariate,
			dblContraVariate);
		...
		if (dblCurrentOF != dblOF && dblContraPointOF != dblOF)
			dblNextVariate = org.drip.function.solver1D.VariateIteratorPrimitive.InverseQuadraticInterpolation
				(dblCurrentVariate, dblVariateMid, dblContraVariate, dblCurrentOF, dblOF, dblContraPointOF);
		else
			dblNextVariate = org.drip.function.solver1D.VariateIteratorPrimitive.FalsePosition (dblCurrentVariate,
	...
	public FixedPointFinderZheng (
		...
		throws java.lang.Exception
	{
		super (dblOFGoal, of, null, org.drip.function.solver1D.VariateIteratorPrimitive.BISECTION, bWhine);
	}
}
