...
public class CollectionUtil {
			...
			final java.lang.String strNULLString)
	{
		...
		java.lang.String[] astrRecord = org.drip.math.common.StringUtil.Split (str2DMap, strRecordDelimiter);
				...
				final java.lang.String strNULLString)
	{
		...
		java.lang.String[] astrRecord = org.drip.math.common.StringUtil.Split (str3DMap, strRecordDelimiter);
		...
		for (int i = 0; i < astrRecord.length; ++i) {
			...
			java.lang.String[] astrKVPair = org.drip.math.common.StringUtil.Split (astrRecord[i], strKVDelimiter);
				...
				final java.lang.String strNULLString)
	{
		...
		java.lang.String[] astrRecord = org.drip.math.common.StringUtil.Split (str4DMap, strRecordDelimiter);
		...
		for (int i = 0; i < astrRecord.length; ++i) {
			...
			java.lang.String[] astrKVPairOut = org.drip.math.common.StringUtil.Split (astrRecord[i],
				strKVDelimiter);
			...
			java.lang.String[] astrKeySet = org.drip.math.common.StringUtil.Split (astrKVPairOut[0],
				strMultiLevelKeyDelimiter);
