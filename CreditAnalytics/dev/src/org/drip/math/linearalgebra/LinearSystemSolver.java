...
public class LinearSystemSolver {
		...
		final double[] adblB)
	{
		...
		double[][] aadblInv = org.drip.math.linearalgebra.Matrix.InvertUsingGaussianElimination (aadblAIn);

		if (null == aadblInv) return null;

		double[][] aadblProduct = org.drip.math.linearalgebra.Matrix.Product (aadblInv, adblB);
