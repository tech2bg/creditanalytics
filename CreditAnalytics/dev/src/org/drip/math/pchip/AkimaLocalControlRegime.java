...
/**
 * AkimaLocalControlRegime generates the local control C1 Slope using the Akima Cubic Algorithm:
 * 
...
public class AkimaLocalControlRegime {
	...
	/**
	 * Construct an Instance of AkimaLocalControlRegime from the Array of the supplied Predictor Ordinates
	 ...
	 * 
	 * @return Instance of AkimaLocalControlRegime
	 */

	public static final AkimaLocalControlRegime Create (
		final double[] adblPredictorOrdinate,
		final double[] adblResponseValue)
	{
		AkimaLocalControlRegime alcr = null;

		try {
			alcr = new AkimaLocalControlRegime (adblPredictorOrdinate, adblResponseValue);
	...
	private AkimaLocalControlRegime (
		final double[] adblPredictorOrdinate,
		final double[] adblResponseValue)
		throws java.lang.Exception
	{
		if (null == (_adblPredictorOrdinate = adblPredictorOrdinate) || null == (_adblResponseValue =
			adblResponseValue))
			throw new java.lang.Exception ("AkimaLocalControlRegime ctr: Invalid Inputs");
