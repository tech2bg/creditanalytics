...
/**
 * LocalControlRegime generates customized Local Regime by trading off Ck for local control.
 *
 * @author Lakshmi Krishnamurthy
 */

public class LocalControlRegime {
	...
	public static final double[] AkimaC1 (
		...
		final double[] adblResponseValue)
	{
		org.drip.math.pchip.AkimaLocalControlRegime alcr =
			org.drip.math.pchip.AkimaLocalControlRegime.Create (adblPredictorOrdinate, adblResponseValue);
	...
	public static final LocalControlRegime Create (
		final double[] adblPredictorOrdinate,
		final double[] adblResponseValue,
	...
	{
		try {
			LocalControlRegime lcr = new LocalControlRegime (adblPredictorOrdinate, adblResponseValue);
