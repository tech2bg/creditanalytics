...
public class MinimalQuadraticHaganWest {
		...
		throws java.lang.Exception
	{
		if (null == (_adblObservation = adblObservation) || null == (_adblPredictorOrdinate =
			adblPredictorOrdinate) || !org.drip.math.common.NumberUtil.IsValid (_dblWeight = dblWeight))
	...
	private boolean setupCoefficients()
	{
		...
		org.drip.math.linearalgebra.LinearizationOutput lssGaussianElimination =
			org.drip.math.linearalgebra.LinearSystemSolver.SolveUsingGaussianElimination (aadblCoeffMatrix,
				adblRHS);
		...
		throws Exception
	{
		...
		for (int i = 0; i < adblConservedConstraint.length; ++i)
			System.out.println ("Conserved Constraint[" + i + "] => " +
				org.drip.math.common.FormatUtil.FormatDouble (adblConservedConstraint[i], 1, 6, 1.));
