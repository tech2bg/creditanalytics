...
public class MonotoneConvexHaganWest {
	...
	class Case1Univariate extends org.drip.math.function.AbstractUnivariate {
		...
		{
			if (!org.drip.math.common.NumberUtil.IsValid (dblPredictorOrdinate) || dblPredictorOrdinate <
	...
	class Case2Univariate extends org.drip.math.function.AbstractUnivariate {
	...
	class Case3Univariate extends org.drip.math.function.AbstractUnivariate {
		private double _dblEta = java.lang.Double.NaN;
		private double _dblResponseZScoreLeft = java.lang.Double.NaN;
		private double _dblResponseZScoreRight = java.lang.Double.NaN;
		private double _dblPredictorOrdinateLeft = java.lang.Double.NaN;
	...
	class Case4Univariate extends org.drip.math.function.AbstractUnivariate {
	...
	{
		int iNumSegment = _adblPredictorOrdinate.length - 1;
		_aAU = new org.drip.math.function.AbstractUnivariate[iNumSegment];
	...
	{
		try {
			_adblResponseValue[0] = org.drip.math.common.NumberUtil.Bound (_adblResponseValue[0], 0., 2. *
				_adblObservation[0]);

			int iNumObservation = _adblObservation.length;

			for (int i = 1; i < iNumObservation; ++i)
				_adblResponseValue[i] = org.drip.math.common.NumberUtil.Bound (_adblResponseValue[i], 0., 2.
					* java.lang.Math.min (_adblObservation[i - 1], _adblObservation[i]));

			_adblResponseValue[iNumObservation] = org.drip.math.common.NumberUtil.Bound
