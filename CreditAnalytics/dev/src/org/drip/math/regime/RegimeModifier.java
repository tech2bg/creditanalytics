...
public class RegimeModifier {
	...
	public static final org.drip.math.regime.MultiSegmentRegime InsertKnot (
		final org.drip.math.regime.MultiSegmentRegime regimeIn,
	...
	public static final org.drip.math.regime.MultiSegmentRegime AppendSegment (
		final org.drip.math.regime.MultiSegmentRegime regimeIn,
		...
		final org.drip.math.segment.PredictorOrdinateResponseDerivative pordRightSegmentLeftEdge)
	{
		...
		org.drip.math.regime.MultiSegmentRegime regimeOut =
			org.drip.math.regime.RegimeBuilder.CreateUncalibratedRegimeEstimator (regimeIn.name(),
		...
		return regimeOut.setupHermite (aPORDOutLeft, aPORDOutRight, null,
			org.drip.math.regime.RegimeCalibrationSetting.CALIBRATE) ? regimeOut : null;
	}
	...
	public static final org.drip.math.regime.MultiSegmentRegime InsertCardinalKnot (
		final org.drip.math.regime.MultiSegmentRegime regimeIn,
		final double dblPredictorOrdinate,
	...
	public static final org.drip.math.regime.MultiSegmentRegime InsertCatmullRomKnot (
		final org.drip.math.regime.MultiSegmentRegime regimeIn,
		final double dblPredictorOrdinate)
	{
