...
public class Inelastics implements java.lang.Comparable<Inelastics> {
	...
	{
		if (!org.drip.math.common.NumberUtil.IsValid (_dblPredictorOrdinateLeft = dblPredictorOrdinateLeft)
			|| !org.drip.math.common.NumberUtil.IsValid (_dblPredictorOrdinateRight =
		...
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblPredictorOrdinate))
			throw new java.lang.Exception ("Inelastics::in => Invalid Inputs");
		...
		throws java.lang.Exception
	{
		if (!in (dblPredictorOrdinate))
			throw new java.lang.Exception ("Inelastics.localize: Invalid inputs!");
	...
	public double delocalize (
		...
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblLocalPredictorOrdinate))
			throw new java.lang.Exception ("Inelastics::delocalize => Invalid Inputs");
	...
	@Override public int compareTo (
		final org.drip.math.segment.Inelastics ieOther)
	{
