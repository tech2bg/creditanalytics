...
/**
 * ExponentialRationalBasisSetParams implements per-segment parameters for the exponential rational basis set
 *  - the exponential tension and the rational tension parameters.
 *
 * @author Lakshmi Krishnamurthy
 */

public class ExponentialRationalBasisSetParams implements org.drip.math.spline.BasisSetParams {
	private double _dblRationalTension = java.lang.Double.NaN;
	private double _dblExponentialTension = java.lang.Double.NaN;

	/**
	 * ExponentialRationalBasisSetParams constructor
	 * 
	...
	public ExponentialRationalBasisSetParams (
		final double dblExponentialTension,
		final double dblRationalTension)
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (_dblExponentialTension = dblExponentialTension) ||
			!org.drip.math.common.NumberUtil.IsValid (_dblRationalTension = dblRationalTension))
			throw new java.lang.Exception ("ExponentialRationalBasisSetParams ctr: Invalid Inputs");
	}
