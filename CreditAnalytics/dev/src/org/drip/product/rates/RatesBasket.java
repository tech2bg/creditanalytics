		...
		throws java.lang.Exception
	{
		...
		aFloatStream[0] = new org.drip.product.rates.FloatingStream (dtEffective.getJulian(),
			dtEffective.addTenor ("3Y").getJulian(), 0.03, true,
				org.drip.product.params.FloatingRateIndex.Create ("ABC-RI-3M"), 4, "Act/360", "Act/360",
					false, null, null, dap, dap, dap, dap, null, null, null, -100., "ABC", "DEF");
		...
		aFloatStream[2] = new org.drip.product.rates.FloatingStream (dtEffective.getJulian(),
			dtEffective.addTenor ("7Y").getJulian(), 0.07, true,
				org.drip.product.params.FloatingRateIndex.Create ("ABC-RI-3M"), 1, "Act/360", "Act/360",
					false, null, null, dap, dap, dap, dap, null, null, null, -100., "ABC", "DEF");
