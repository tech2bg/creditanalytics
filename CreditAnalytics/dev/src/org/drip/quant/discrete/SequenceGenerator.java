...
public abstract class SequenceGenerator {
	...
	public org.drip.quant.discrete.SampleSequenceAgnosticMetrics sequence (
		final int iNumEntry)
	{
		...
		try {
			return new org.drip.quant.discrete.SampleSequenceAgnosticMetrics (adblSequence, null);
