...
public class Poisson extends org.drip.quant.random.RandomSequenceGenerator {
		...
		final org.drip.quant.distribution.Univariate distPopulation)
	{
		...
		try {
			return new org.drip.sequence.bounds.PoissonSequenceAgnosticMetrics (adblSequence, null ==
