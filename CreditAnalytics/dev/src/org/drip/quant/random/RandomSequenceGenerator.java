...
public abstract class RandomSequenceGenerator {
	...
	public org.drip.sequence.bounds.SingleSequenceAgnosticMetrics sequence (
		final int iNumEntry,
		final org.drip.quant.distribution.Univariate distPopulation)
	{
		try {
			return new org.drip.sequence.bounds.SingleSequenceAgnosticMetrics (sequence (iNumEntry),
				distPopulation);
