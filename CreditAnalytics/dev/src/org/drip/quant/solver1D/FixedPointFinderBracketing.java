...
public class FixedPointFinderBracketing extends org.drip.quant.solver1D.FixedPointFinder {
	protected int _iIteratorPrimitive = -1;
	protected org.drip.quant.solver1D.IteratedBracket _ib = null;

	private org.drip.quant.solver1D.ExecutionInitializer _ei = null;
	...
	{
		if (org.drip.quant.solver1D.VariateIteratorPrimitive.BISECTION == iIteratorPrimitive)
			return org.drip.quant.solver1D.VariateIteratorPrimitive.Bisection (dblCurrentVariate,
				dblContraVariate);

		if (org.drip.quant.solver1D.VariateIteratorPrimitive.FALSE_POSITION == iIteratorPrimitive)
			return org.drip.quant.solver1D.VariateIteratorPrimitive.FalsePosition (dblCurrentVariate,
				dblContraVariate, dblCurrentOF, dblContraPointOF);

		double dblIntermediateVariate = org.drip.quant.solver1D.VariateIteratorPrimitive.Bisection
		...
		if (org.drip.quant.solver1D.VariateIteratorPrimitive.QUADRATIC_INTERPOLATION == iIteratorPrimitive)
			return org.drip.quant.solver1D.VariateIteratorPrimitive.QuadraticInterpolation (dblCurrentVariate,
				dblIntermediateVariate, dblContraVariate, dblCurrentOF, _of.evaluate
					(dblIntermediateVariate), dblContraPointOF);

		if (org.drip.quant.solver1D.VariateIteratorPrimitive.INVERSE_QUADRATIC_INTERPOLATION ==
			iIteratorPrimitive)
			return org.drip.quant.solver1D.VariateIteratorPrimitive.InverseQuadraticInterpolation
				(dblCurrentVariate, dblIntermediateVariate, dblContraVariate, dblCurrentOF, _of.evaluate
					(dblIntermediateVariate), dblContraPointOF);

		if (org.drip.quant.solver1D.VariateIteratorPrimitive.RIDDER == iIteratorPrimitive)
			return org.drip.quant.solver1D.VariateIteratorPrimitive.Ridder (dblCurrentVariate,
				dblIntermediateVariate, dblContraVariate, dblCurrentOF, _of.evaluate
					(dblIntermediateVariate), dblContraPointOF);
	...
	@Override protected boolean iterateVariate (
		final org.drip.quant.solver1D.IteratedVariate iv,
		final org.drip.quant.solver1D.FixedPointFinderOutput rfop)
	{
	...
	@Override protected org.drip.quant.solver1D.ExecutionInitializationOutput initializeVariateZone (
		final org.drip.quant.solver1D.InitializationHeuristics ih)
	{
		org.drip.quant.solver1D.BracketingOutput bop = null;

		if (null != ih && org.drip.quant.solver1D.InitializationHeuristics.SEARCH_HARD_BRACKETS ==
			ih.getDeterminant())
		...
		try {
			_ib = new org.drip.quant.solver1D.IteratedBracket (bop);
		...
		throws java.lang.Exception
	{
		...
		if (org.drip.quant.solver1D.VariateIteratorPrimitive.BISECTION != (_iIteratorPrimitive =
			iIteratorPrimitive) && org.drip.quant.solver1D.VariateIteratorPrimitive.FALSE_POSITION !=
				_iIteratorPrimitive &&
					org.drip.quant.solver1D.VariateIteratorPrimitive.QUADRATIC_INTERPOLATION !=
						_iIteratorPrimitive &&
							org.drip.quant.solver1D.VariateIteratorPrimitive.INVERSE_QUADRATIC_INTERPOLATION
								!= _iIteratorPrimitive &&
									org.drip.quant.solver1D.VariateIteratorPrimitive.RIDDER !=
										_iIteratorPrimitive)
