	...
	@Override public boolean setupRegressors()
	{
		...
		try {
				...
				("CreateZeroCurveFromPeriods", _strRegressionScenario)
			{
				...
				private java.util.List<org.drip.analytics.cashflow.CouponPeriod> _lsCouponPeriod = new
				...
				@Override public boolean preRegression()
				{
					...
					for (int i = 0; i < NUM_PERIOD_NODES; ++i) {
						...
						try {
							_lsCouponPeriod.add (new org.drip.analytics.cashflow.CouponPeriod (dblStart,
