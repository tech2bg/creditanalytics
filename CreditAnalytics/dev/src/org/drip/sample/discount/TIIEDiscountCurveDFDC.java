...
public class TIIEDiscountCurveDFDC {
		...
		throws Exception
	{
		...
		LocalControlCurveParams crbpSmoothening2 = new LocalControlCurveParams (
		...
		DiscountCurve dcSmoothening2 = RatesScenarioCurveBuilder.SmoothingLocalControlBuild (
			dcShapePreserving,
			lccShapePreserving,
			crbpSmoothening2,
			aRBS,
