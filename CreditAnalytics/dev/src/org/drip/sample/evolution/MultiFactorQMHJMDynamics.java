...
/**
 * MultiFactorQMHJMDynamics demonstrates the Construction and Usage of the Multi-Factor Gaussian HJM Model
 *  Dynamics for the Evolution of the Discount Factor Quantification Metrics - the Instantaneous Forward
 *  Rate, the LIBOR Forward Rate, the Shifted LIBOR Forward Rate, the Short Rate, the Compounded Short Rate,
 *  and the Price.
 *
 * @author Lakshmi Krishnamurthy
 */

public class MultiFactorQMHJMDynamics {
	...
	private static final GaussianMultiFactorHJM HJMInstance (
		final JulianDate dtStart,
		final String strCurrency,
		...
		throws Exception
	{
		...
		return new GaussianMultiFactorHJM (
			mfv,
			auForwardRate
		);
	}
	...
	private static final void QMEvolution (
		final GaussianMultiFactorHJM hjm,
		final JulianDate dtStart,
		final String strCurrency,
		final String strViewTenor,
		final String strTargetTenor,
		...
		throws Exception
	{
		...
		GaussianMultiFactorHJM hjm = HJMInstance (
			dtSpot,
			strCurrency,
			mktSurfFlatVol1,
			mktSurfFlatVol2,
