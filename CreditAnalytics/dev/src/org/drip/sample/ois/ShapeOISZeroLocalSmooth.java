 ...
 * 		the Local Curve Control parameters to the array of Cash and OIS Stretches and the shape
 ...
 * 		and the Local Curve Control parameters to the array of Cash and OIS Stretches and the shape
 * 		preserving discount curve.
 ...
 * 		curve calibrator and the Local Curve Control parameters to the array of Cash and OIS Stretches
...
public class ShapeOISZeroLocalSmooth {
		...
		throws Exception
	{
		...
		for (int i = 0; i < astrTenor.length; ++i)
			aCash[i] = CashBuilder.CreateCash (dtEffective, dtEffective.addTenorAndAdjust (astrTenor[i], "USD"), "USD");
