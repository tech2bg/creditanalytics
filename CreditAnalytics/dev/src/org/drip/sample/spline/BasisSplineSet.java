...
public class BasisSplineSet {
		...
		throws Exception
	{
		...
		ConstitutiveState seg1 = ConstitutiveState.Create (0.0, 1.0, fs, sc, segParams, null);

		ConstitutiveState seg2 = ConstitutiveState.Create (1.0, 2.0, fs, sc, segParams, null);
