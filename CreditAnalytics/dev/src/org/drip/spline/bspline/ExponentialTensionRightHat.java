...
/**
 * ExponentialTensionRightHat implements the right exponential hat basis function laid out in the basic
...
public class ExponentialTensionRightHat extends org.drip.spline.bspline.TensionBasisHat {
	...
	{
		if (0 > iOrder)
			throw new java.lang.Exception ("ExponentialTensionRightHat::calcDerivative => Invalid Inputs");
