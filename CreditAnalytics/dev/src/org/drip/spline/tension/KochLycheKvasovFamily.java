...
public class KochLycheKvasovFamily {
		...
		final org.drip.spline.basis.ExponentialTensionSetParams etsp)
	{
		...
		org.drip.function.deterministic.R1ToR1 auPhy = new org.drip.function.deterministic.R1ToR1
			(null) {
		...
		org.drip.function.deterministic.R1ToR1 auPsy = new org.drip.function.deterministic.R1ToR1
			(null) {
			@Override public double evaluate (
				final double dblX)
				throws java.lang.Exception
		...
		try {
			return new org.drip.spline.bspline.SegmentBasisFunctionSet (2, etsp.tension(), new
				org.drip.function.deterministic.R1ToR1[] {auPhy, auPsy});
