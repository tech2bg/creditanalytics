...
public class NonlinearCurveCalibrator {
	...
	private double calcCalibrationMetric (
		final org.drip.state.manager.NonlinearDiscountFactorDiscountCurve dc,
		final org.drip.analytics.definition.DiscountCurve dcTSY,
		final org.drip.analytics.definition.DiscountCurve dcEDSF,
		...
		final boolean bFlat)
	{
		...
		if (!(dc instanceof org.drip.state.manager.NonlinearDiscountFactorDiscountCurve)) {
		...
		try {
			calibrateIRCurve ((org.drip.state.manager.NonlinearDiscountFactorDiscountCurve) dc, dcTSY, dcEDSF, aCalibComp,
