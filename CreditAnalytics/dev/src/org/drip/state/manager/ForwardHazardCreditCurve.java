...
public class ForwardHazardCreditCurve extends org.drip.analytics.definition.CreditCurve {
		...
		final org.drip.param.definition.NodeTweakParams ntp)
	{
		...
		try {
			return new ForwardHazardCreditCurve (_dblStartDate, _strName, adblHazardBumped, _adblHazardDate,
		...
		throws java.lang.Exception
	{
		if (null == _mapQuote || 0 == _mapQuote.size() || null == strInstr || strInstr.isEmpty() ||
			...
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getQuote => Cannot get " + strInstr);

		return _mapQuote.get (strInstr);
	}

	@Override public ForwardHazardCreditCurve createParallelHazardShiftedCurve (
		final double dblShift)
	{
		...
		try {
			return new ForwardHazardCreditCurve (_dblStartDate, _strName, adblHazard, _adblHazardDate,
				_adblRecoveryRate, _adblRecoveryDate, _dblSpecificDefaultDate);
		} catch (java.lang.Exception e) {
			e.printStackTrace();
		}
	...
	@Override public ForwardHazardCreditCurve createParallelShiftedCurve (
		final double dblShift)
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblShift)) return null;
		...
		try {
			cc = new ForwardHazardCreditCurve (_dblStartDate, _strName, _adblHazardRate, _adblHazardDate,
				_adblRecoveryRate, _adblRecoveryDate, _dblSpecificDefaultDate);
		} catch (java.lang.Exception e) {
			e.printStackTrace();
		...
		final double dblRecovery)
	{
		...
		try {
			if (bSingleNode)
				cc = org.drip.state.creator.CreditCurveBuilder.FromHazardNode (_dblStartDate, _strName,
		...
		final org.drip.param.definition.NodeTweakParams ntp)
	{
		...
		if (org.drip.param.definition.CreditNodeTweakParams.CREDIT_TWEAK_NODE_PARAM_RECOVERY.equalsIgnoreCase
			...
			try {
				return new ForwardHazardCreditCurve (_dblStartDate, _strName, _adblHazardRate, _adblHazardDate,
			...
			if (org.drip.param.definition.CreditNodeTweakParams.CREDIT_TWEAK_NODE_MEASURE_HAZARD.equalsIgnoreCase
				...
				try {
					return new ForwardHazardCreditCurve (_dblStartDate, _strName, adblHazardBumped,
				...
				try {
					if (cntp._bSingleNodeCalib)
						cc = org.drip.state.creator.CreditCurveBuilder.FromHazardNode (_dblStartDate,
							_strName, _adblHazardRate[0], _adblHazardDate[0], _adblRecoveryRate[0]);
					else
						cc = new ForwardHazardCreditCurve (_dblStartDate, _strName, _adblHazardRate,
							_adblHazardDate, _adblRecoveryRate, _adblRecoveryDate, _dblSpecificDefaultDate);
				} catch (java.lang.Exception e) {
					e.printStackTrace();
	...
	{
		if (null == dt)
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getSurvival => Invalid Date");
		...
		throws java.lang.Exception
	{
		if (null == strTenor || strTenor.isEmpty())
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getSurvival => Bad tenor");
		...
		throws java.lang.Exception
	{
		if (null == dt1 || null == dt2)
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getEffectiveSurvival => Invalid date");
		...
		throws java.lang.Exception
	{
		if (null == strTenor1 || strTenor1.isEmpty() || null == strTenor2 || strTenor2.isEmpty())
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getEffectiveSurvival => bad tenor");
	...
	{
		if (null == dt1 || null == dt2)
			throw new java.lang.Exception ("ForwardHazardCreditCurve::calcHazard => Invalid dates");
	...
	{
		if (null == strTenor || strTenor.isEmpty())
			throw new java.lang.Exception ("ForwardHazardCreditCurve::calcHazard => Bad Tenor");
	...
	{
		if (null == dt)
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getRecovery => Invalid Date");
	...
	{
		if (null == strTenor || strTenor.isEmpty())
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getRecovery => Invalid Tenor");
	...
	{
		if (null == dt1 || null == dt2)
			throw new java.lang.Exception ("ForwardHazardCreditCurve::getEffectiveRecovery => Invalid date");
		...
		throws java.lang.Exception
	{
		if (null == strTenor1 || strTenor1.isEmpty() || null == strTenor2 || strTenor2.isEmpty())
			throw new java.lang.Exception
				("ForwardHazardCreditCurve::getEffectiveRecovery => Invalid tenor");
		...
		throws java.lang.Exception
	{
		...
		ForwardHazardCreditCurve cc = new ForwardHazardCreditCurve (dblStart, "XXS", adblHazardRate,
