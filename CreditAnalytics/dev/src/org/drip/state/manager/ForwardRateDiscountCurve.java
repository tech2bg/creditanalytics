...
public class ForwardRateDiscountCurve extends org.drip.analytics.definition.DiscountCurve {
	...
	protected ForwardRateDiscountCurve (
		...
		throws java.lang.Exception
	{
		if (null == dc) throw new java.lang.Exception ("ForwardRateDiscountCurve copy ctr: Invalid inputs");
		...
		throws java.lang.Exception
	{
		if (null == _mapQuote || 0 == _mapQuote.size() || null == strInstr || strInstr.isEmpty() ||
			...
			throw new java.lang.Exception ("ForwardRateDiscountCurve::getQuote => Cannot get quotes for " +
				strInstr);

		return _mapQuote.get (strInstr);
	}

	@Override public ForwardRateDiscountCurve createParallelShiftedCurve (
		final double dblShift)
	{
		...
		ForwardRateDiscountCurve dc = null;

		try {
			dc = new ForwardRateDiscountCurve (new org.drip.analytics.date.JulianDate (_dblStartDate),
	...
	@Override public ForwardRateDiscountCurve createParallelRateShiftedCurve (
		final double dblShift)
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblShift)) return null;
		...
		try {
			return new ForwardRateDiscountCurve (new org.drip.analytics.date.JulianDate (_dblStartDate),
		...
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblDate))
			throw new java.lang.Exception ("ForwardRateDiscountCurve::getDF => Got NaN for date");
		...
		throws java.lang.Exception
	{
		if (null == dt1 || null == dt2)
			throw new java.lang.Exception ("ForwardRateDiscountCurve::getEffectiveDF => Got null for date");
		...
		throws java.lang.Exception
	{
		if (null == strTenor1 || strTenor1.isEmpty() || null == strTenor2 || strTenor2.isEmpty())
			throw new java.lang.Exception ("ForwardRateDiscountCurve::getEffectiveDF => Got bad tenor");
		...
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblDt1) || !org.drip.math.common.NumberUtil.IsValid
			(dblDt2))
			throw new java.lang.Exception ("ForwardRateDiscountCurve::calcImpliedRate => Invalid input");
	...
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblDate))
			throw new java.lang.Exception ("ForwardRateDiscountCurve::calcImpliedRate => Got NaN for date");
		...
		throws java.lang.Exception
	{
		if (null == strTenor || strTenor.isEmpty())
			throw new java.lang.Exception ("ForwardRateDiscountCurve::calcImpliedRate => Got empty date");
